...
let validatorParams = [
    ...
    (0, express_validator_1.check)('precio').isFloat({ min: 0 }).withMessage('El precio debe ser un número válido mayor o igual a 0').bail(),
    ...
    (0, express_validator_1.check)('cantidad_ingreso').isInt({ min: 0 }).withMessage('La cantidad de ingreso debe ser un número entero mayor o igual a 0').optional().bail(),
